...
* [swig](http://www.swig.org/) and ALSA development libraries (`python-midi` requires these in order to build its sequencer code successfully, although ly2video doesn't use that code)
...
page](http://packman.links2linux.org/package/fmpeg)), or via [YaST
and/or
